...
if __name__ == '__main__':
    ...
    loader.load_scattering_flare('E:/dataset/Flare7Kpp/Flare7K',
                                             'E:/dataset/Flare7Kpp/Flare7k/Scattering_Flare/Compound_Flare')
    loader.load_light_source('E:/dataset/Flare7Kpp/Flare7k',
                                         'E:/dataset/Flare7Kpp/Flare7k/Scattering_Flare/Light_Source')
    ...
    loader.load_reflective_flare('E:/dataset/Flare7Kpp/Flare7K',
                                             'E:/dataset/Flare7Kpp/Flare7k/Reflective_Flare')
    channels = [0,1,2,3]
    for c in channels:
        try:
            os.makedirs(f'../dataset/flare7kpp_local/input/c{c}')
            os.makedirs(f'../dataset/flare7kpp_local/gt/c{c}')
        except FileExistsError:
            print(f'Folder ../dataset/flare7kpp_local/input/c{c} already exists.')
            print(f'Folder ../dataset/flare7kpp_local/gt/c{c} already exists.')
